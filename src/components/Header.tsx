      ...
      <div className="relative container mx-auto px-3 sm:px-4 py-4 sm:py-6">
        <div className="text-center space-y-2">
          <div className="flex items-center justify-center gap-2 sm:gap-3 mb-2">
            ...
            <h1 className="text-2xl sm:text-4xl md:text-6xl font-bold bg-gradient-to-r from-yellow-400 via-purple-300 to-cyan-400 bg-clip-text text-transparent leading-tight">
              DIVINE DISCIPLINE ENGINE
            </h1>
            <Zap className="w-6 h-6 sm:w-8 sm:h-8 text-cyan-400 animate-pulse" />
          </div>
          
          <p className="text-sm sm:text-lg md:text-xl text-purple-200 font-medium px-2">
            ⚔️💎 Track. Level. Dominate. Forget self-help. This is self-SOVEREIGNTY. 💎⚔️
          </p>
          
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-2 sm:gap-4 text-xs sm:text-sm md:text-base text-purple-300 mt-4 px-2">
            <span className="bg-purple-800/50 px-2 sm:px-3 py-1 rounded-full border border-purple-500/30">
              📊 Daily Target: 100+ XP
            </span>
            <span className="bg-purple-800/50 px-2 sm:px-3 py-1 rounded-full border border-purple-500/30">
              📈 Weekly Goal: 700+ XP
